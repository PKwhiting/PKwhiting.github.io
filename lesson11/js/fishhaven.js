...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=e1a24a23dfe17b8311787ee919f089dc";
fetch(apiURL)
...
const api1URL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=e1a24a23dfe17b8311787ee919f089dc";
fetch(api1URL)
  .then((response) => response.json())
  .then((forecastObject) => {
